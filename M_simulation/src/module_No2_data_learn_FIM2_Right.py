...
def Learning_and_Model_Saving():
    ...
    def open_pass_pickle():
        with open('./learned_model/model/Rightlearned_model_new_pickled.pkl', 'rb') as f:
    ...
    def Machine_Learning_Model_Creation(Title):
        with open("./learned_model/learned_data/"+Title+"Right.pkl", 'rb') as f:merge_data2 = pickle.load(f)
