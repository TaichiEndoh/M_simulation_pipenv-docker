...
def Model_Call_Posterior_Prediction():
    ...
    with open("./learned_model/model/"+"Right"+"model_save_time_pass.pkl", 'rb') as f:
    ...
    Out_Result_tk = Out_Result_pass_name
    ...
    #20220331 chenge imput csv name !
    ...
    def open_rehabilitation_data(image_file_path_v):
            ...
            'F11', 'F12', 'F13', 'F14', 'F15', 'F16', 'F17', 'F18', 'F19'], axis=1)
                ...
                def if_left_right(num):
                    if num == 'Right':
                        df_or=df
                        Paralysis_of_the_left__right_side_of_the_brain_infarction=df_or[df_or['part'] == "L"]
    ...
    rezurt_F1_19.to_csv(r""+"./learned_model"+'/output_log_data/'+"Right_rezurt_1_19_"+outname+'.csv', encoding = 'shift-jis')
    ...
    dfp_input = dfpp
    #save time title data
    dfp_input.to_csv(r""+"./learned_model"+'/input_log_data/'+"use_Right_inp_"+now_time_name+'.csv', encoding = 'shift-jis')
    return rezurt_F1_19

#right_rezurt_F1_19 = Model_Call_Posterior_Prediction()
